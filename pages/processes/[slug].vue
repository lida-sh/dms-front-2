...
import { useGetProcessClientBySlugService } from '~/composables/home/useProcess.service';
import { useGetSubProcessClientBySlugService } from '~/composables/home/useSubProcess.service';


const route = useRoute();

const getProcess = useGetProcessClientBySlugService();
const { data, pending, error } = useAsyncData('process' + route.params.slug, () => getProcess(route.params.slug as string, {}), {})
</script>
