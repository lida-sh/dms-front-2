<template>
    <div class="flex flex-col items-center justify-center gap-2 min-h-24">
        <img v-if="extension == 'docx' || extension == 'doc'" src="/assets/images/file-icons/w.jpg" alt="word" class="w-9">
