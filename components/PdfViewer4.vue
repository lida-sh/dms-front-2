...
// غیرفعال کردن worker - استفاده از main thread
...
const loadPdf = async () => {
  ...
  try {
    ...
    const loadingTask = pdfjsLib.getDocument({
      ...
      disableWorker: true, // غیرفعال کردن worker
      disableFontFace: false, // اجازه استفاده از فونت‌های تعبیه شده در PDF
      useSystemFonts: true, // استفاده از فونت‌های سیستم
      standardFontDataUrl: null, // غیرفعال کردن جستجو برای فونت‌های استاندارد
      cMapUrl: null, // غیرفعال کردن cmaps
      cMapPacked: false,
