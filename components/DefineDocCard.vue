<template>
    <div class="card w-[80rem] h-full flex-col text-white shadow-md">
        ...
        <div class="bg-[#4749e3] h-[25rem] rounded-t-3xl px-10 lg:px-20 pt-16">
            <h1 class="text-xl lg:text-3xl font-bold mb-12"><span class="">{{ docTypesSlides[currentSlide].title }}</span> (<span
